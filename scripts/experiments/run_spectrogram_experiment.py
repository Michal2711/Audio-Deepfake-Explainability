...
def main():
    ...
    if method == 'rise':
        ...
        explainer = SpectrogramExplainability(
            ...
            spec_type=spectrogram_cfg.get('spec_type', 'mel'),
        ...
        explainer = SpectrogramExplainability(
            ...
            patch_time_frames=occlusion_cfg.get('patch_time_frames', 2048),
            stride_time_frames=occlusion_cfg.get('stride_time_frames', 2048),
            patch_freq_percent=occlusion_cfg.get('patch_freq_percent', 25.0),
            stride_freq_percent=occlusion_cfg.get('stride_freq_percent', 25.0),
